...
// .\..\..\.build\win64_vs2022\bin\shadercDebug.exe -f vs_50_mesh.sc -o vs_50_mesh.bin --type v --platform windows --debug --profile s_5_0 -i .\..\..\src
...
Output main( float3 a_normal : NORMAL , float3 a_position : POSITION) { Output _varying_; _varying_.v_color0 = float4(1.0, 0.0, 0.0, 1.0);; _varying_.v_normal = float3(0.0, 0.0, 1.0);; _varying_.v_pos = float3(0.0, 0.0, 0.0);; _varying_.v_view = float3(0.0, 0.0, 0.0);;
{
